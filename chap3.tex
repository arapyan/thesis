...
The Phase $1$ upgrade program will be carried out during the long shutdown $2$ (LS2) in $2018$. However, the HPDs in the HO calorimeter were replaced by SIPMs during LS1. SIPMs are pixel arrays of avalanche photodiodes each operating in Geiger mode. By adding the signal of all the pixels together gives a measurement of the number of incident photons. SIPMs are compact devices that operate at $2$ orders of magnitude lower voltages compared to the HPDs. The gain is similar to that of photomultipliers but the quantum efficiencies are a factor of $2$ compared to the HPDs. In addition the SIPMs are not affected by magnetic fields of up to $4$ Tesla   while about $10\%$ of the HPDs experience rapid breakdown at lower magnetic fields from $0.2-3.0$ Tesla affecting the HO calorimeter in particular in the fringe fields outside of the solenoid. 
