...
%$b\bar{b} j\gamma$                                      &   $8.1 \times 10^{5}$              \\
%$c\bar{c} j\gamma$                                      &   $2.5 \times 10^{6}$              \\
%$b\bar{b} jj$                                           &   $6.1 \times 10^{8}$              \\
%$c\bar{c} jj$                                           &   $6.5 \times 10^{8}$              \\
...
\hline
Process / Selection Stage           &  $b\bar{b}j\gamma$                  &  $c\bar{c}j\gamma$                  & $b\bar{b}jj$                    &  $c\bar{c}jj$                       & $t\bar{t}(\gamma)$                \\  \hline
